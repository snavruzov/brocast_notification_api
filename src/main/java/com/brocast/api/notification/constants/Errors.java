...
import com.brocast.api.notification.beans.Error;
 ...
 */
public class Errors {
    public final static com.brocast.api.notification.beans.Error HASH_EMPTY = new Error("INVALID_HASH", "Wrong hash or not found");
